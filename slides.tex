...
\begin{frame}{Institutional Design: A System Reliant on One Pillar}
  ...
  \begin{itemize}
    ...
    \item \textbf{Political Choice:} Post-war Germany prioritized a state-run, universalist system, whereas Switzerland enforced a mandatory occupational pillar. This historical divergence is key to their current vulnerabilities.
  \end{itemize}
  
  \begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{three_pillars_chart.jpg}
  \caption{The Three Pillars of the German Pension System. Source: Pensionfriend.de}
  \end{figure}

  \textbf{Financing:}
  \begin{itemize}
    \item Contributions (Employer/Employee split 50/50).
    \item \textbf{Federal Subsidy (\textit{Bundeszuschuss}):} $\sim$30\% of the budget comes from general taxes, not contributions.
  \end{itemize}
\end{frame}
...
\begin{frame}{The Demographic Time Bomb is Ticking}
  \begin{itemize}
    \item \textbf{Transition:} This rule-based static system now faces a massive exogenous shock: demography.
...
\begin{frame}{Labor Supply \& The Politics of Retirement Age}
  \begin{itemize}
    \item \textbf{Transition:} A second shock comes from the labor market, where policy and behavior often diverge.
...
\begin{frame}{The Sustainability Factor: Shifting Risk by Dampening Growth}
  ...
  \begin{itemize}
    \item \textbf{Transition:} Given the demographic pressure, the formula has a built-in endogenous adjustment mechanism.
...
\begin{frame}{The "Standard Pensioner" \& Falling Replacement Rates}
  \begin{itemize}
    \item \textbf{Transition:} These pressures and adjustments have direct consequences for the key political trade-offs.
...
\begin{frame}{The Social Safety Net: \textit{Grundsicherung im Alter}}
  ...
  \begin{itemize}
    ...
    \item \textbf{The Floor: Basic Income Support (\textit{Grundsicherung im Alter}).}
    \begin{itemize}
...
\begin{frame}{The Unseen Debt Burden}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Pension subsidies already consume $\sim$25-30\% of the entire German federal budget.
        ...
        \begin{itemize}
            \item The present value of all pension promises the state has made is enormous: \textbf{over 300\% of Germany's GDP}. This is the "hidden" debt. Germany's implicit pension debt is among the highest in the OECD and dwarfs that of countries with significant pre-funded components, like the Netherlands or Switzerland.
        \end{itemize}
