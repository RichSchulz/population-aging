...
\begin{frame}{The Economic Trilemma \& Mackenroth's Theorem}
  ...
  \begin{itemize}
    \item \textbf{Contribution Rate} (\textit{Beitragssatz}): How much workers pay. Politically capped (20-22\%)
...
\begin{frame}{Pillar 1: The "Points System" (\textit{Entgeltpunkte})}
  ...
  \begin{itemize}
    ...
    \item \textbf{Contribution Assessment Ceiling} Maximum income subject to contributions. Currently €96,600/year (2025). Income above this ceiling does not generate pension points
...
\begin{frame}{The Sustainability Factor: Shifting Risk by Dampening Growth}
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item In 2018 the factor was suspended till 2025 (2031 if the current bill passes)
  \end{itemize}
\end{frame}


\begin{frame}{Reforms were taken}
  \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Savings:} Crucial for sustainability; dampens contribution rate rise by $\sim$1-2 pp
    \end{itemize}
    \item \textbf{The Policy Anomaly: "Rente mit 63" (2014)}
    \begin{itemize}
        \item Allowed long-term contributors to retire early without penalty
        \item \textbf{Cost:} $\sim$€40 bn/year; huge "deadweight loss" by subsidizing exit of skilled labor
    \end{itemize}
    \item \textbf{Social Expansion: "Mütterrente" I \& II (2014/2019)}
    \begin{itemize}
        \item Expanded pension points for raising children born before 1992
        \item \textbf{Cost:} $\sim$€12 bn/year
    \end{itemize}
...
\begin{frame}{Who is paying for the reforms?}
  \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Forecast:} Would break the politically sensitive 20\% barrier at some point
        \item Not Automatically adjusted
    \end{itemize}
    \item \textbf{The pension system gets tax subsidies}
    \begin{itemize}
    \item The federal government will have to subsidize the pension system more and more in the future (currently 92 billion EUR/year)     \end{itemize}

  \end{itemize}
\end{frame}

\begin{frame}{Why a lower replacement rate is a problem}
  \textbf{The Reality for Low-Income Pensioners:}
  \begin{itemize}
    \item \textbf{Problem:} A low(er) statutory pension level can lead to old-age poverty. The average monthly pension is 1.240 Euro per month (2024)
...
\begin{frame}{Politics Overrules Economics (again)}
  \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{The current bill (2025):}
    \begin{itemize}
        ...
        \item \textbf{The Cost:} Further deactivates the Sustainability Factor, removing the automatic brake on spending
...
\begin{frame}{Conclusion}
  \textbf{Summary:}
  \begin{itemize}
    \item Germany's PAYG system worked well under a favorable demographic and economic growth, but is now challenged by its own demographic decline
  ...
  \textbf{The Outlook:}
  \begin{itemize}
    \item The \textit{Generationenkapital} is a historic step towards capital funding, but it is way too small to solve the structural problem
...
\begin{frame}{References}
  \begin{itemize}
    \item German Council of Economic Experts (Sachverständigenrat). \textit{Jahresgutachten} 2023/2024
    \item Deutsche Rentenversicherung (DRV). \textit{Rentenversicherung in Zeitreihen} 2024
    \item OECD. \textit{Pensions at a Glance} 2023: OECD and G20 Indicators
    \item Mackenroth, G. (1952). \textit{Die Reform der Sozialpolitik}. Mohr Siebeck
    \item Börsch-Supan, A. (2000). \textit{A Pension System for the 21st Century}. MIT Press
    \item Börsch-Supan, A., \& Coile, C. (2018). "Social Security and Retirement: A Comparative Perspective." \textit{Journal of Economic Literature}, 56(4), 1366-1416
    \item Bundesministerium für Arbeit und Soziales. \textit{Rentenversicherungsbericht} 2024
    \item European Commission. \textit{The 2021 Ageing Report: Economic and Budgetary Projections for the EU Member States} (2019-2070)
  \end{itemize}
\end{frame}
